...
{
    // نموذج الشحنات والحاويات (مكتمل 100% مع العلاقات)
    public class Shipment
    {
        ...
        public string ShippingLine { get; set; } // مثال: Maersk, MSC
        ...
        public string Status { get; set; } = "Pending"; // Pending, Loading, Sailed, Arrived, Cleared

        // العلاقات: موانئ التحميل والوصول (مرتبطة بجدول Location)
        ...
        // العلاقات: السيارات داخل هذه الحاوية والمستندات المرفقة لها
